...
Despite entering two phase, there was no discontinuity in @fig-nw45bara.
...
It doesn't seem to be the case that *just* entering the two phase region will cause a discontinuity. It could be related to where it happens, from which direction, or what pressure it happens at.
